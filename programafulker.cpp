...
int main()
{
  ...
  //Adding edges weight in the graph
    addEdge(graph, 0 ,5 , 3,  1 ,0 , 0, 0);
    addEdge(graph, 0 ,0 , 0 , 0 ,3 , 0, 0);
    addEdge(graph, 0 ,0 , 0 , 0 ,1 , 3, 0);
    addEdge(graph, 0 ,0 , 0 , 0 ,0 , 3, 0);
    addEdge(graph, 0 ,0 , 0 , 0 ,0 , 0, 3);
    addEdge(graph, 0 ,0 , 0 , 0 ,0 , 0, 8);
    addEdge(graph, 0 ,0 , 0 , 0 ,0 , 0, 0);
